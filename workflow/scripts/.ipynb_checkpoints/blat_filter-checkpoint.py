...
class RealignmentFilter:
    ...
    def __init__(
        ...
        self._blat_read_query_filename = 'query.fa'
        self._blat_read_query_output_psl_filename = 'output.psl'
        self._blat_mate_query_filename = 'mate_query.fa'
        self._blat_mate_query_output_psl_filename = 'mate_output.psl'
